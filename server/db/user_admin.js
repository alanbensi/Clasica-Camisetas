...
sequelize.query('INSERT INTO users (username, fullname, email, password, address, admin) VALUES (?, ?, ?, ?, ?, ?)',
    {replacements: ['SuperAdmin', 'Super Admin', 'superadmin@gmail.com', 'clasica123', 'calle falsa 123', true]}
).then((response) => {
...
sequelize.query('INSERT INTO users (username, fullname, email, password, address, admin) VALUES (?, ?, ?, ?, ?, ?)',
    {replacements: ['SuperAdmin2', 'Super Admin', 'superadmin2@gmail.com', 'clasica123', 'calle falsa 123', true]}
).then((response) => {
